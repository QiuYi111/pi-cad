...
Target the Pi-CAD manifest version, currently Blender 4.5.3. Probe the managed binary's version before relying on optional API.

- EEVEE engine: `BLENDER_EEVEE_NEXT` in 4.5. Do not copy Blender 5-only engine assumptions.
...
- For animation curve edits, inspect the action representation exposed by 4.5 instead of assuming Blender 5 slot APIs.
