...
- Read [references/cookbook.md](references/cookbook.md), then copy the linear-elastic or differentiable-sensitivity Recipe asset into `simulation/**`.
...
- Use the generated `pi-cad-tools` contract for the current simulation and optimization lifecycle.
