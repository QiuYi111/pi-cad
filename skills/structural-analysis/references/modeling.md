...
Apply distributed loads over physical regions when appropriate. Check resultant force and moment against the intended load case. Resolve geometric surface identifiers with the unified Probe before assigning engineering meaning.
