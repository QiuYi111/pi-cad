...
- The only exceptions: the user already stated the mapping explicitly in this conversation, or the task is provably frame-agnostic AND the user declined the question. A silent assumption is never an exception.
